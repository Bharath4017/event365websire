...
/*
Plugin Name: Webfont_Kit_1 #417154
...
add_action( 'admin_init', array('MyFontsInstaller_417154','checkInstallation'));
add_action( 'wp_enqueue_scripts', array('MyFontsInstaller_417154','myfonts_loadupWebfonts' ));
